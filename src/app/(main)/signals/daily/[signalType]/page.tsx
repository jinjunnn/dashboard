...
interface DailySignalTypePageProps {
  params: Promise<{
    signalType: string;
  }>;
}
...
// 信号类型页面组件
async function SignalTypeContent({ params }: DailySignalTypePageProps) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <Badge variant="outline">日线信号</Badge>
          </div>
...
// 导出主页面
export default function DailySignalTypePage({ params }: DailySignalTypePageProps) {
  return (
