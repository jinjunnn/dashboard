...
import { TrendingUp, Activity, BarChart3, Target, Shield, Square, Zap, ArrowLeft, TrendingDown, ArrowUp, Minus, LineChart } from "lucide-react"
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono">{formatPrice(signal.price * 0.99)} - {formatPrice(signal.price * 1.005)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">建议仓位</span>
                  <Badge variant="outline">{signalConfig.riskLevel === "R1" ? "40-50%" : signalConfig.riskLevel === "R2" ? "30-40%" : signalConfig.riskLevel === "R3" ? "20-30%" : "10-20%"}</Badge>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-muted-foreground">
                  {signalConfig.riskLevel === "R1" ? "低风险，适合长期持有" : 
                   signalConfig.riskLevel === "R2" ? "中低风险，适合中期投资" :
                   signalConfig.riskLevel === "R3" ? "中高风险，需要密切关注" : 
                   "高风险，建议分批建仓"}
                </div>
                <div className="text-xs text-muted-foreground">
                  * 日线信号适合中长期投资策略，建议结合基本面分析
                </div>
              </div>
            </div>
          </div>
