...
import { TrendingUp, Activity, BarChart3, Target, Shield, Square, Zap, ArrowLeft, RefreshCw, Share2, BookmarkPlus, AlertCircle, Download } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>基于技术指标的关键价位分析</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>该信号类型的历史统计数据</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>基于当前信号的交易策略建议</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono">
                    {formatPrice(signal.price * 0.995)} - {formatPrice(signal.price * 1.002)}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="text-muted-foreground text-xs">* 以上建议仅供参考，投资有风险，入市需谨慎</div>
              </div>
            </div>
          </div>
        </CardContent>
